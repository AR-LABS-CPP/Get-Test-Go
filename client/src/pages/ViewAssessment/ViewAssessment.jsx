...
const ViewAssessment = (props) => {
    ...
    const handleDeleteAssessmentQuestion = (question) => {
        axios.post("http://localhost:4321/assessment/question/delete", {
                                    ...
                                    assessmentQuestionsSet.map(q => {
                                        if (q.question_type_name === "MCQ") {
                                            return <CustomAccordin key={q.question} title={q.question}>
                                                <div key={q.question} className="border-[1px] border-gray-300 my-5 rounded-md">
                                                    ...
                                                    <div className="w-full flex justify-center">
                                                        <button className="bg-blue-600 hover:bg-blue-500 focus:bg-blue-500 text-white px-20 rounded-lg py-3 mt-10 mb-10 w-[200px]" onClick={() => handleDeleteAssessmentQuestion(q.question)}>
                                                            Delete
                                                        </button>
                                                    </div>
                                                </div>
