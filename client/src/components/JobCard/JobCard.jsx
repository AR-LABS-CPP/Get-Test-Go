const JobCard = (props) => {
    return (
        <div>
            ...
            <div className={`w-72 h-72 flex flex-col justify-around border-[1px] border-gray-300 shadow-lg h-92 rounded-bl-lg rounded-br-lg overflow-hidden ${props.additionalStyling}`}>
