const AssessmentCard = (props) => {
    return (
        ...
        //     <div className={`w-full h-56 flex flex-col justify-around border-[1px] border-gray-300 shadow-lg h-92 m-2 rounded-bl-lg rounded-br-lg overflow-hidden ${props.additionalStyling}`}>
